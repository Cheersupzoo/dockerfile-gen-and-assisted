...
export const DetectDockerFile = () => {
  ...
  return (
    <div>
      ...
      <div className="text-center">Automatically detect</div>
      <div className="text-center text-sm text-gray-500">Framework</div>
      <div className="text-center">{detectState.framework}</div>
      <div className="flex justify-center">
        <button
